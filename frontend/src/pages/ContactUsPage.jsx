...
//   { icon: Mail, label: 'Adresse e-mail', value: 'heallinkteam@gmail.com', delay: 0.8 },
//   { icon: Phone, label: 'Numéro de téléphone', value: '+1 (555) 012-3456', delay: 0.9 },
  { icon: MapPin, label: 'Localisation', value: 'Tunisie', delay: 1.0 },
];
...
const ContactUsPage = () => {
  ...
  const handleMailto = (e) => {
    ...
    const recipient = 'adam.thabet36@gmail.com';
    // Encoder les composants pour une URL
    const subject = encodeURIComponent(`Nouveau message de contact de ${formData.name}`);
    const body = encodeURIComponent(`Nom de l'expéditeur : ${formData.name}\nEmail de l'expéditeur : ${formData.email}\n\n---\n\nMessage:\n${formData.message}`);
    ...
    <div className="min-h-screen bg-gray-900 p-4 sm:p-12 font-sans relative overflow-hidden">
      ...
      >
        ...
        <div className="lg:pr-8">
          ...
          >
            Nous sommes là pour vous aider à réussir vos études. Cliquez sur "Envoyer le message" pour ouvrir votre client e-mail avec les informations pré-remplies.
          </motion.p>
