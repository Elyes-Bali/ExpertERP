      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-10">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-3 gap-6">
            ...
            <StatCard
              title="Particuliers"
              value={suppliers.filter((s) => s.type === "individual").length}
              icon={
                <User
                  size={20}
            ...
            <StatCard
              ...
              value={suppliers.filter((s) => s.type === "professional").length}
              icon={
                <Building2
                  size={20}
          ...
          <AnimatePresence>
            {showForm && (
              <motion.div
                ...
                className="bg-white dark:bg-slate-900 rounded-[2.5rem] border border-gray-100 dark:border-slate-800 shadow-xl shadow-gray-200/30 dark:shadow-none overflow-hidden"
              >
                  ...
                  <div className="flex items-center gap-4">
                    ...
                    <div>
                      ...
                      <p className="text-[10px] font-bold text-gray-400 dark:text-slate-500 uppercase tracking-tighter">
                        Saisir les détails du profil et de l'adresse
                      </p>
                    </div>
                  </div>
                  {editing && (
          ...
          <div className="space-y-6">
            <div className="flex items-center justify-between px-2">
              <h3 className="text-xs font-black text-gray-400 dark:text-slate-500 uppercase tracking-widest flex items-center gap-2">
                ...
                Affichage de {currentSuppliers.length} sur{" "}
                {filteredSuppliers.length} contacts
              </h3>
            </div>
