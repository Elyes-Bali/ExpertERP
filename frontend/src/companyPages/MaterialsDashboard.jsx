...
const MaterialsDashboard = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setForm({ name: "", quantity: 0, price: 0, isActive: true });
    fetchMaterials();
  };
      ...
      <main className="flex-1 flex flex-col min-w-0">
          ...
          <div className="flex items-center gap-4">
            ...
            <div className="min-w-0">
              ...
              <p className="hidden sm:block text-xs font-medium tracking-tight text-gray-500 dark:text-gray-400">
                Organisez et suivez vos entités métier actives
              </p>
            </div>
          </div>
        ...
        <div className="p-4 lg:p-8 max-w-6xl mx-auto w-full space-y-6 lg:space-y-8">
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
            <StatCard
              title="Total des matériaux"
              value={materials.length}
              icon={<CircuitBoard className="text-indigo-600" />}
              ...
              >
                <div className="flex-1 w-full space-y-2">
                  ...
                  <div className="relative">
                    ...
                    />
                    <input
                      placeholder="ex : Écran, Clavier, Matière première X"
                ...
                <div className="flex gap-2 w-full md:w-auto">
                  ...
                  >
                    ...
                    {editingId ? "Enregistrer les modifications" : "Créer le matériau"}
                  </button>
              ...
              {filteredMaterials.length === 0 ? (
                <div className="flex flex-col items-center justify-center py-20 bg-gray-50/30 dark:bg-gray-700/30 rounded-2xl border border-dashed border-gray-200 dark:border-gray-600">
                  ...
                  <p className="mt-2 text-sm font-bold italic text-gray-400 dark:text-gray-300">
                    Aucun matériau correspondant à vos critères
                  </p>
                </div>
              ) : (
                    ...
                    {currentMaterials.map((material) => (
                      ...
                      >
                        <div className="flex items-center gap-4 min-w-0">
                          ...
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              ...
                              >
                                {material.isActive ? "Actif" : "En pause"}
                              </span>
                            </div>
                          </div>
                        </div>
                        ...
                        <div className="flex items-center gap-1.5 opacity-0 group-hover:opacity-100 transition-opacity">
                          ...
                          <button
                            onClick={async () => {
                              if (confirm("Supprimer définitivement ce matériau ?")) {
