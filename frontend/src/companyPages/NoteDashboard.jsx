      ...
      <div className="p-4 lg:p-8 max-w-6xl mx-auto w-full space-y-6 lg:space-y-8">
        ...
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 lg:gap-6">
          <StatCard
            ...
            value={notes.length}
            icon={<StickyNote className="text-indigo-600" />}
        ...
        >
          <div className="px-6 py-4 border-b border-gray-50 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-700/30 flex items-center gap-2">
            ...
            <h2 className="text-xs font-bold uppercase tracking-widest text-gray-700 dark:text-gray-200">
              {editingId ? "Modifier la note existante" : "Ajouter une nouvelle note"}
            </h2>
          </div>
            ...
            <form onSubmit={handleSubmit} className="flex flex-col md:flex-row items-end gap-6">
              <div className="flex-1 w-full space-y-2">
                ...
                <div className="relative">
                  ...
                  <input
                    placeholder="ex : Vous pouvez ajouter ici des notes importantes concernant vos factures..."
              ...
              <div className="flex gap-2 w-full md:w-auto">
                ...
                >
                  ...
                  {editingId ? "Enregistrer les modifications" : "Créer une note"}
                </button>
                  ...
                  {currentNotes.map((note) => (
                    ...
                    >
                      <div className="flex items-center gap-4 min-w-0">
                        <div className="bg-emerald-100 dark:bg-emerald-800 text-emerald-700 dark:text-emerald-200">
                          <StickyNote size={20} />
                        </div>
                        <div className="min-w-0 ">
