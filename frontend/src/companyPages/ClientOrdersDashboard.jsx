  ...
  <div className="flex flex-col lg:flex-row min-h-screen bg-[#FDFDFE] dark:bg-gray-950 transition-colors duration-300">
      ...
      <main className="flex-1 flex flex-col min-w-0">
        ...
        <div className="p-6 lg:p-10 max-w-7xl mx-auto w-full space-y-10">
          ...
          >
            <div className="px-8 py-6 border-b border-gray-50 dark:border-gray-800 bg-gray-50/30 dark:bg-gray-800/20 flex items-center gap-4">
            ...
            <form onSubmit={handleSubmit} className="p-8 lg:p-10 space-y-10">
              ...
              {stockWarning.length > 0 && (
                <div className="mb-6 p-4 rounded-2xl border border-red-200 bg-red-50 dark:bg-red-900/20 dark:border-red-800">
                ...
                <AnimatePresence>
                  {currentOrders.map((order) => (
                    <motion.div
                      ...
                      className="bg-white dark:bg-[#111827] p-8 rounded-[2.5rem] border border-gray-100 dark:border-gray-800 hover:border-indigo-100 dark:hover:border-indigo-900/50 hover:shadow-2xl hover:shadow-indigo-500/5 transition-all flex flex-col justify-between group"
                    >
                      <div>
                        <div className="flex justify-between items-start mb-6">
                          ...
                          <div className="flex gap-2">
                            ...
                            <button
                              ...
                              className="flex items-center gap-2 bg-rose-500 text-white px-4 py-2 rounded-xl text-[10px] font-black uppercase tracking-widest hover:bg-rose-600 transition-colors"
                            >
                              <Trash2 size={12} />
                            </button>
                          </div>
                        ...
                        <div className="grid grid-cols-2 gap-6 mb-6">
                          <div>
                            <p className="text-[9px] font-black text-gray-900 dark:text-gray-400 uppercase mb-1">
                              Projet
                            </p>
                            <p className="text-[11px] font-bold text-gray-800 dark:text-gray-200 uppercase">
                              {order.project?.name || "Facturation standard"}
                            </p>
                          </div>
                        ...
                        <div className="space-y-2 border-t border-gray-50 dark:border-gray-800 pt-4">
                          {order.items.slice(0, 4).map((item, i) => (
                            <div
                              key={i}
                              className="flex justify-between items-center text-[11px] font-medium text-gray-500 dark:text-gray-400"
                            >
                              <span className="flex items-center gap-2 max-w-[40%] truncate">
                                <div className="w-1 h-1 rounded-full bg-gray-200 dark:bg-gray-200"></div>{" "}
                                {item.name}
                              </span>
                          ...
                          {order.items.length > 4 && (
                            <p className="text-[9px] text-gray-400 italic">
                              +{order.items.length - 4} autres articles
                            </p>
                          )}
                        </div>
                      </div>
                      ...
                      <div className="mt-8 pt-6 border-t-2 border-dashed border-gray-50 dark:border-gray-800 flex items-center justify-between">
                        <div>
                          ...
                          <p className="text-[10px] font-bold text-gray-400 uppercase">
                            Timbre fiscal : {order.timbreFiscal} TND
                          </p>
