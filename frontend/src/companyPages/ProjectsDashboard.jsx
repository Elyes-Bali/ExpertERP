...
/**
 * REDESIGNED PROJECTS DASHBOARD
 * Aligned with the Tax & VAT Management aesthetic
 * Supports Dark Mode
 */
          ...
          >
            <div className="px-6 py-4 border-b border-gray-50 dark:border-gray-700 bg-gray-50/30 dark:bg-gray-700/30 flex items-center gap-2">
              ...
              <h2 className="text-xs font-bold uppercase tracking-widest text-gray-700 dark:text-gray-200">
                {editingId ? "Modifier le projet existant" : "Ajouter un nouveau projet"}
              </h2>
            </div>
                      ...
                      >
                        <div className="flex items-center gap-4 min-w-0">
                          <div className={`p-3 rounded-xl shrink-0 ${
                            project.isActive ? "bg-indigo-50 dark:bg-indigo-900 text-indigo-600" : "bg-gray-200 dark:bg-gray-600 text-gray-500"
                          }`}>
                            <Folder size={20} />
                          </div>
                          <div className="min-w-0">
                            ...
                            <div className="flex items-center gap-2 mt-1">
                              <span className={`text-[10px] font-black uppercase tracking-tighter px-2 py-0.5 rounded ${
                                project.isActive ? "bg-emerald-100 dark:bg-emerald-800 text-emerald-700 dark:text-emerald-200" : "bg-gray-200 dark:bg-gray-600 text-gray-500"
                              }`}>
                                {project.isActive ? "En ligne" : "En pause"}
                              </span>
                            </div>
                          </div>
                        </div>
